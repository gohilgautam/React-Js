        ...
        >
            <div className="container mx-auto px-4 flex justify-between items-center h-full">
                <Link to="/" className="text-2xl font-bold tracking-tighter flex items-center gap-2 group">
                    <span className="text-green-500 group-hover:text-green-400 transition-colors">Pixabay</span>
                    <span className={`${scrolled ? 'text-gray-800 dark:text-white' : 'text-white'} transition-colors`}>Clone</span>
                </Link>

                <div className="hidden md:flex items-center gap-8">
                    <Link to="#" className={`text-sm font-semibold hover:text-green-400 transition-colors ${scrolled ? 'text-gray-600 dark:text-gray-300' : 'text-white/90'
                        }`}>
                        Explore
                    </Link>
                    <Link to="#" className={`text-sm font-semibold hover:text-green-400 transition-colors ${scrolled ? 'text-gray-600 dark:text-gray-300' : 'text-white/90'
                    ...
                    <Link
                        to="#"
                        className={`px-6 py-2 rounded-full text-sm font-semibold transition-all transform hover:scale-105 active:scale-95 ${scrolled
                    ...
                    <Link
                        to="#"
                        className={`px-6 py-2 rounded-full text-sm font-semibold flex items-center gap-2 transition-all transform hover:scale-105 active:scale-95 ${scrolled
