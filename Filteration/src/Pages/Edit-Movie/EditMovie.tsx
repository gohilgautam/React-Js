...
export default function Edit_Movie() {
  ...
  return (
    <div
      className="min-h-screen w-full flex flex-col items-center justify-center px-4 py-10 relative bg-fixed bg-cover bg-center"
      style={{
    ...
    >
      ...
      {/* Card Container */}
      <div className="relative z-10 bg-white/10 backdrop-blur-2xl shadow-2xl rounded-3xl p-6 md:p-8 w-full max-w-lg border border-white/20">
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="relative">
            <select
              ...
              onChange={handleEvent}
              className="block w-full rounded-xl bg-white/20 p-4 text-white border border-white/30 focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-red-600 transition-all duration-300"
              required
            >
              {categories.map(cat => (
