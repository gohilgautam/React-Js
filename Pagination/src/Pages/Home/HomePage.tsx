...
import hero3 from "../../assets/images/hero_3.webp";
import aboutimg from "../../assets/images/about_3.webp"
...
export default function HomePage() {
  const slides = [
    ...
    },
    {
      id: 2,
      image: hero2,
      title: "Creative Interior Solutions",
      subtitle: "Bring your dream space to life",
      button: "Learn More",
    },
    {
      id: 3,
  ...
  useEffect(() => {
    const timer = setInterval(() => setCurrent((prev) => (prev + 1) % length), 60*60*100);
    ...
    <div className="font-sans text-gray-800">
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex space-x-2">
          {slides.map((_, i) => (
            <button key={i} onClick={() => setCurrent(i)} className={`w-3 h-3 rounded-full ${current === i ? "bg-green-600" : "bg-gray-400"}`} />
          ))}
        </div>
      </section>
        ...
        <div className="container mx-auto text-center">
          ...
          >
            <input
              ...
              className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition"
            />
            <input
              type="email"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-semibold">Blog and Updates</h2>
          <p className="mt-4 text-gray-600 max-w-xl mx-auto">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum rem magni tempora incidunt.
          </p>
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((blog, i) => (
              ...
              >
                <h4 className="text-sm text-gray-500">September 20, 2019</h4>
                <h3 className="mt-2 text-xl font-semibold">Eiusmod tempor veniam magna fugiat</h3>
                <a href="#" className="inline-block mt-4 text-green-600 hover:underline">
                  Read More &rarr;
                </a>
              </motion.div>
            ))}
